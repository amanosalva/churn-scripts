...
#Se incorporó un bloque de validación

ValidacionYTransformacionDatasetChurn <- function(path_origen, path_destino, trama, token, opcion){
  ...
  out <- tryCatch(
    {  
      ...
      lista_output <- list(NULL,NULL,NULL,NULL)
      ...
      switch(opcion, 
             ...
             B = {
              ...
              #                                             "mtotal_n"= col_double()), na = "")
               ...
               #Proceso de validación para cada producto.
             ...
             O = {
               ...
               recibeTramaPrepago <- function(trama,tokenp){
                 ...
                 registro[,c("produc_c" , "pli_sn_c")] <- as.character(unlist(registro[,c("produc_c", "pli_sn_c")]))
               ...
               recibeTramaPostpago <- function(trama,tokenp){
                 ...
                 registro[,c("produc_c" , "linper_c"   ,"conren_c"  , "fld119_c"  , "fld120_c"  , "fld121_c"   ,
                             "fld122_c")] <- as.character(unlist(registro[,c("produc_c" , "linper_c"   ,"conren_c"  , "fld119_c"  , "fld120_c"  , "fld121_c"   ,
                                                                                           "fld122_c")]))
               ...
               recibeTramaControl <- function(trama,tokenp){
                 ...
                 registro[,c("tcntel_n"  ,"edad_n"    , "antig_n"   , "eqanti_n"  , "rec1to_n"   ,"rec1fi_n"  , "rec1pr_n"  , "rec1pe_n"   ,
                             ...
                             "rep4to_3_n")] <- as.numeric(as.character(unlist(registro[,c("edad_n"    , "antig_n"   , "eqanti_n"  , "rec1to_n"   ,"rec1fi_n"  , "rec1pr_n"  , "rec1pe_n"   ,
                                                                                          ...
                                                                                          "rep4to_3_n")])))
                 #Asignación del tipo de dato. Convierte factor a character
                 registro[,c("produc_c" , "linper_c"  , "conren_c", "fld119_c"   ,"fld120_c"  , "fld121_c"  , "fld122_c")] <- as.character(unlist(registro[,c("produc_c" , "linper_c"  , "conren_c", "fld119_c"   ,"fld120_c"  , "fld121_c"  , "fld122_c")]))
  ...
  if(!is.null(lista_output[[1]])){
  
    if(grepl('INCORRECT_VALUES_IN_THE_FEATURES',lista_output[[1]])){
      lista_output <- lista_output
    }else{
      lista_output[[1]] <- out
